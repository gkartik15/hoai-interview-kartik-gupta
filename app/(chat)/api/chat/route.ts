...
import { getTokenStats } from '@/lib/ai/tools/get-token-stats';

export const maxDuration = 60;

export async function POST(request: Request) {
  try {
  console.log("Main chat route - Start"); 
  ...
  if (hasAttachments && isInvoiceRequest) {
    console.log("Redirecting to invoice route");
    return Response.redirect(new URL('/api/chat/invoice', request.url), 307);
  }
